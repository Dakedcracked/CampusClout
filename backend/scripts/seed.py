...
async def seed():
    async with AsyncSessionLocal() as db:
        ...
        for u in USERS:
            ...
            if existing_user:
                print(f"  skip {u['username']} or {u['email']} (exists)")
            ...
            try:
                ...
                print("FAILED TO FLUSH USER:", u["username"], file=sys.stdout)
        ...
        comments_added = 0
        IMAGES = [
            "https://images.unsplash.com/photo-1523240795612-9a054b0db644?w=800&q=80", # friends hanging out
            "https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?w=800&q=80", # library
            "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=800&q=80", # campus building
            "https://images.unsplash.com/photo-1555099962-4199c345e5dd?w=800&q=80", # coding late
            "https://images.unsplash.com/photo-1511882150382-421056c89033?w=800&q=80", # dorm room
        ]
        ...
        for user in created_users:
            for _ in range(random.randint(2, 5)):
                ...
                media_url = random.choice(IMAGES) if has_image else None
                media_type = "image" if has_image else None
                ...
                db.add(post)
                await db.flush() # flush to get post.id for comments
                
                # Add 0 to 3 comments per post (threads)
                ...
                for _ in range(num_comments):
                    ...
                    comment = PostComment(
                        ...
                        content=random.choice(["Exactly!", "I feel this so much.", "Facts 😂", "Wait, really?", "So true bestie"]),
                    )
                    db.add(comment)
                    comments_added += 1
        ...
        await db.commit()
        print(f"  posts and {comments_added} comments seeded with images")
